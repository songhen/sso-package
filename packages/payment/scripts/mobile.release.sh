...
branch_prefix="payment-mobile-sdk-release-v"
tag_prefix="PaymentMobileSDK-v"
...
cp -R packages/payment/mobile-client/dist/* $temp_folder/
cp -R packages/payment/mobile-client/android $temp_folder/
cp -R packages/payment/mobile-client/ios $temp_folder/
