...
branch_prefix="core-sdk-release-v"
tag_prefix="CoreSDK-v"
...
cp -R packages/core/dist/src/* $temp_folder/
cp packages/core/package.json $temp_folder/
cp packages/core/CHANGELOG.md $temp_folder/
done_emoji
